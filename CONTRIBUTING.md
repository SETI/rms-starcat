# Contributing to rms-starcat

Thank you for your interest in contributing to rms-starcat! This document provides guidelines and instructions for contributing to the project.
...
2. Clone your fork locally:
   ...
   ```bash
   git clone https://github.com/your-username/rms-starcat.git
   cd rms-starcat
   ```
...
The test suite is self-contained: it requires no network access and no copy of the real
star catalogs, which are far too large to keep in the repository. The helpers in
`tests/catalog_data.py` write small synthetic UCAC4, YBSC, and SPICE catalogs, in the real
on-disk formats, into a temporary directory. Add records there rather than adding test
data files or reaching out to externally hosted catalogs.
...
Thank you for contributing to rms-starcat!
